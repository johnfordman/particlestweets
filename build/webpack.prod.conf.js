...
var webpackConfig = merge(baseWebpackConfig, {
  module: {
    loaders: utils.styleLoaders({ sourceMap: settings.build.productionSourceMap, extract: true })
  },
  ...
  vue: {
    loaders: utils.cssLoaders({
      sourceMap: settings.build.productionSourceMap,
      extract: true
    })
  },
  plugins: [
    ...
    new HtmlWebpackPlugin({
      filename: path.resolve(__dirname, settings.build.index),
      template: 'index.html',
      inject: true,
      minify: {
        removeComments: true,
